...
**Week:** w2026-36 | **Sample:** top-8 skills by install count

### Structure distribution (top-8)

| Structure            | Count | Share | Examples |
|---|---|---|---|
| domain-noun          |     7 |   88% | frontend-slides, guizang-social-card-skill, internet-court-skill |
| verb-noun            |     0 |    0% | — |
| brand-prefixed       |     0 |    0% | — |
...
watermarks-remover, archify, frontend-slides
