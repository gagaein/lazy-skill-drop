...
**Week:** w2026-26 | **Sample:** top-8 skills by install count

### Structure distribution (top-8)

| Structure            | Count | Share | Examples |
|---|---|---|---|
| domain-noun          |     6 |   75% | frontend-slides, guizang-social-card-skill, obsidian-second-brain |
...
frontend-slides, guizang-social-card-skill, planning-with-files
