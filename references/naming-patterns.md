...
**Week:** w2026-29 | **Sample:** top-8 skills by install count

### Structure distribution (top-8)

| Structure            | Count | Share | Examples |
|---|---|---|---|
| domain-noun          |     7 |   88% | frontend-slides, guizang-social-card-skill, obsidian-second-brain |
| verb-noun            |     0 |    0% | — |
| brand-prefixed       |     0 |    0% | — |
| portmanteau          |     1 |   12% | archify |

### High-velocity names this week (fastest growing)

frontend-slides, planning-with-files, guizang-social-card-skill
