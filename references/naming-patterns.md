...
**Week:** w2026-22 | **Sample:** top-8 skills by install count

### Structure distribution (top-8)

| Structure            | Count | Share | Examples |
|---|---|---|---|
| domain-noun          |     6 |   75% | frontend-slides, obsidian-second-brain, pm-claude-skills |
| verb-noun            |     1 |   12% | design-extract |
| brand-prefixed       |     0 |    0% | — |
| portmanteau          |     1 |   12% | nopua |

### High-velocity names this week (fastest growing)

frontend-slides, agents-best-practices, design-extract
