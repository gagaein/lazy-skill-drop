...
**Week:** w2026-20 | **Sample:** top-8 skills by install count

### Structure distribution (top-8)

| Structure            | Count | Share | Examples |
|---|---|---|---|
| domain-noun          |     5 |   62% | frontend-slides, obsidian-second-brain, gpt-image2-ppt-skills |
...
frontend-slides, design-extract, obsidian-second-brain
