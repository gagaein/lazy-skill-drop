...
**Week:** w2026-22 | **Sample:** 8 skills by install/star count
...
|---|---|---|---|---|---|---|---|
| zarazhangrui/frontend-slides | 18886 | tool-only | ✓ | — | — | 3 | 0 |
| Manavarya09/design-extract | 2914 | no-skill-md | — | — | — | 0 | 0 |
| Agents365-ai/drawio-skill | 1846 | no-skill-md | — | — | — | 0 | 0 |
| eugeniughelbur/obsidian-second-brain | 1338 | full-pipeline | ✓ | ✓ | — | 9 | 5 |
| wuji-labs/nopua | 1308 | single-file | — | — | — | 0 | 0 |
| DenisSergeevitch/agents-best-practices | 1062 | rules-pack | — | ✓ | — | 0 | 15 |
| mohitagw15856/pm-claude-skills | 879 | tool-only | ✓ | — | — | 2 | 0 |
| AgriciDaniel/claude-blog | 827 | tool-only | ✓ | — | — | 9 | 0 |
